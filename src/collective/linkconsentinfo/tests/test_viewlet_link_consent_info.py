# -*- coding: utf-8 -*-
from collective.linkconsentinfo.interfaces import ICollectiveLinkconsentinfoLayer
...
class ViewletIntegrationTest(unittest.TestCase):
    ...
    def test_link_consent_info_is_registered(self):
        ...
        alsoProvides(self.request, ICollectiveLinkconsentinfoLayer)
        ...
        manager.update()
        my_viewlet = [v for v in manager.viewlets if v.__name__ == 'link-consent-info']  # NOQA: E501
        self.assertEqual(len(my_viewlet), 1)

    # XXX would be nice to have this test working:
    # def test_link_consent_info_is_not_available_on_newsitem(self):
